...
--
-- Máy chủ: 172.17.0.5
-- Thời gian đã tạo: Th12 19, 2019 lúc 10:43 AM
...
CREATE TABLE `Employee` (
  `BusinessEntityID` int(11) NOT NULL,
  `NationalIDNumber` int(11) DEFAULT NULL,
...
--
-- Cấu trúc bảng cho bảng `PurchaseOrderID`
--

CREATE TABLE `PurchaseOrderID` (
  `PurchaseOrderID` int(11) NOT NULL,
...
--
-- Chỉ mục cho bảng `PurchaseOrderID`
--
ALTER TABLE `PurchaseOrderID`
...
--
-- AUTO_INCREMENT cho bảng `PurchaseOrderID`
--
ALTER TABLE `PurchaseOrderID`
