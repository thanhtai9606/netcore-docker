...
--
-- Máy chủ: 172.17.0.5
-- Thời gian đã tạo: Th12 20, 2019 lúc 07:36 AM
...
--
-- Cấu trúc bảng cho bảng `ProductSubCatetory`
--

CREATE TABLE `ProductSubCatetory` (
...
--
-- Chỉ mục cho bảng `ProductSubCatetory`
--
ALTER TABLE `ProductSubCatetory`
...
--
-- AUTO_INCREMENT cho bảng `ProductSubCatetory`
--
ALTER TABLE `ProductSubCatetory`
...
--
ALTER TABLE `Product`
  ADD CONSTRAINT `Product_ibfk_1` FOREIGN KEY (`ProductSubcategoryID`) REFERENCES `ProductSubCatetory` (`ProductSubCategoryID`);
...
--
-- Các ràng buộc cho bảng `ProductSubCatetory`
--
ALTER TABLE `ProductSubCatetory`
  ADD CONSTRAINT `ProductSubCatetory_ibfk_1` FOREIGN KEY (`ProductCategoryID`) REFERENCES `ProductCategory` (`ProductCategoryID`),
  ADD CONSTRAINT `ProductSubCatetory_ibfk_2` FOREIGN KEY (`ProductSubCategoryID`) REFERENCES `Product` (`ProductSubcategoryID`);
